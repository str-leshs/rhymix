package TeamRhymix.Rhymix.domain.post.controller;
...
import TeamRhymix.Rhymix.global.security.CustomUserDetails;
...
import TeamRhymix.Rhymix.domain.post.dto.PostResponseDto;
...
public class PostController {
    ...
    public ResponseEntity<PostResponseDto> getTodayPost(
        ...
        PostResponseDto response = PostResponseDto.builder()
                ...
                .coverImage(track != null ? track.getCoverImage() : null)
                .album(track != null ? track.getAlbum() : null)
                .duration(track != null ? track.getDuration() : null)
                .mood(post.getMood())
